      ...
      <div class="row">
        <div class="col-md-6">
			<div class="site-info">
				...
				printf( esc_html__( 'Все права защищены. %2$s', 'consultup' ), 'Consultup', '<a href="' . esc_url( __( 'https://flowertimes.ru/', 'consultup' ) ) . '" title="Сайт про растения" rel="nofollow" target="_blank">Flowertimes.ru</a>' );
				?>		
			</div>
		</div>
